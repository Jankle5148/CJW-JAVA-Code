...
public class LoginJFrame extends MyJFrame {
    ...
    public LoginJFrame() {
        //设置图标
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/pers/cjw/functionDemo/a02game/image/logo.jpg")));
    ...
    public void initView() {
        JLabel image = new JLabel(new ImageIcon(getClass().getResource("/pers/cjw/functionDemo/a02game/image/kit.jpg")));
