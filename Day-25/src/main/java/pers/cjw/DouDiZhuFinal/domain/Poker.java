...
public class Poker extends JLabel implements MouseListener {
    ...
    //显示正面
    //图片在 src/main/resources 下，编译后会被复制到 classpath 根部，
    //所以用 getResource 按"包路径"读取，不再依赖运行时的当前工作目录
    public void turnFront() {
        this.setIcon(new ImageIcon(getClass().getResource("/pers/cjw/DouDiZhuFinal/image/poker/" + name + ".png")));
        this.up = true;
    }

    //显示背面
    public void turnRear() {
        this.setIcon(new ImageIcon(getClass().getResource("/pers/cjw/DouDiZhuFinal/image/poker/rear.png")));
        this.up = false;
    }
